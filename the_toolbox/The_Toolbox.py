...
class SystemTrayIcon:
    def __init__(self):
        ...
        self.icon_path = os.path.join(self.home_dir, '/home/ssc/Schreibtisch/the-toolbox/the_toolbox/icon.png')
        self.script_dir = os.path.join(self.home_dir, '/home/ssc/Schreibtisch/the-toolbox/the_toolbox/')
